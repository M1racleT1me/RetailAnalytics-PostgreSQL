...
-- CREATE INDEX idx_trans_customer_card ON Transactions(Customer_Card_ID);
-- CREATE INDEX idx_cards_customer ON Cards(Customer_Card_ID, Customer_ID);
-- CREATE INDEX idx_personal_customer ON PersonalInformation(Customer_ID);

-- DROP INDEX idx_trans_customer_card;
-- DROP INDEX idx_cards_customer;
-- DROP INDEX idx_personal_customer;
